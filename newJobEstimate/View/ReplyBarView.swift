                    ...
                    VStack (alignment:.center) {
                        ...
                        VStack(alignment: HorizontalAlignment.leading) {
                            ...
                            Button(action:{
                                ...
                                let focusReplyIndex =    appData.HomefocusPublishPosts.firstIndex (where :{$0.id == chekedPostId})
                                 
                                if focusReplyIndex != nil {
                                    appData.HomefocusPublishPosts[focusReplyIndex!].reply_count += 1
                                }
                                
  
                                appData.updatePostReplyNum(postId: Int64(chekedPostId))
